...
// CUSTOM HANDLERS
static esp_err_t ignore_handler(httpd_req_t *req) {
  ...
  return httpd_resp_send(req, resp, 0);
...
void startCameraServer(){
   ...
   httpd_uri_t stream_uri = {
    ...
    if (httpd_start(&camera_httpd, &config) == ESP_OK) {
        ...
        // Custom URIs
        httpd_register_uri_handler(camera_httpd, &ignore_uri);
